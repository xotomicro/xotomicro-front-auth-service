...
module.exports = {
    ...
    plugins: getMicroFrontPluginsConfig({packageName: "xotomicro_front_auth_service", packageDependencies, HtmlWebpackPlugin, EnvironmentPlugin, ModuleFederationPlugin}),
}
